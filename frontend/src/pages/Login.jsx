...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center flex-col gap-6 bg-black text-white">
      <h1 className="text-3xl font-semibold">Welcome to MyShop</h1>
      <button
        type="button"
        onClick={handleLogin}
        className="flex items-center gap-3 px-6 py-3 text-lg font-medium text-black bg-white border border-neutral-300 rounded-md cursor-pointer transition duration-150 hover:bg-neutral-200 active:scale-95"
      >
